// Jameson Colbert, Data Mgmt, PS4, 24 March 2021
// Dr. Adam Okulicz-Kozaryn

/* 
For PS4, beginning on line 235, I introduced data from New York and Pennsylvania, 
including COVID information, population (2019), population density (2011), poverty (2019),
and poverty rate (2019).

I was able to see correlation between population density and covid cases. More
work is needed to combine NYC borough observations.
*/
...
drop _merge
save NJ_PA_NY_CovidPopPovertyDensity.dta
...
/*trying to fix New York City issue, for PS5*/ //replace by hand

clear
use NJ_PA_NY_CovidPopPoverty.dta
replace county = subinstr(county, ", New York City, New York","New York City, New York", .)
keep if county == "New York City, New York" | county == "Bronx, New York" | county == "Kings, New York" | county == "New York, New York" | county == "Richmond, New York" | county == "Queens, New York" 
l

//look into other variables (such as risk factors) race, age, obesity, smoking
